...
**[Phone Details Master]** is a web application that allows users to view and search phone brands and also view the brand phones.

## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

> React, Redux, Jest, React Testing Library, and the News API.
...
- [Live Demo Link](http://pdm.nogdevouse.com)
...
```
  cd my-folder
  git https://github.com/hopeforkoami/phoneDetailsMaster.git
```
